'''From learnt causal regressors, computing ACE and plotting in heat map'''
import matplotlib
matplotlib.use('Agg')
...
for filename in os.listdir("./" + foldername + "/"):
	...
	ax.set_xticks(np.arange(20))#Since Tau was 20
	ax.set_yticks(np.arange(len(headers)))
	ax.set_yticklabels(headers)
	ax.set_xticklabels([i for i in range(1, 21)])#Since Tau was 20
