...
if __name__ == "__main__":
    ...
    parser.add_argument('--objective', default='H_mod', type=str, help='beta-vae objective proposed in Higgins et al. or Burgess et al. H/B')
    parser.add_argument('--model', default='H_mod', type=str, help='model proposed in Higgins et al. or Burgess et al. H/B')
